          ...
          <div className="text-center">
            ...
            <nav className="mx-auto mt-8 flex w-[200px] flex-col gap-3">
              ...
              <button
                ...
                className="inline-flex min-h-12 w-full items-center justify-center gap-2 border border-white/30 bg-white/10 text-sm font-bold uppercase tracking-[0.08em] text-white backdrop-blur-sm transition hover:border-white/60 hover:bg-white/20"
              >
